...
namespace _282
{
    class Program
    {
        ...
        {
            int optiune;
            Console.WriteLine("Alegeti una din problemele de mai jos: "); Console.WriteLine();
            ...
            Console.WriteLine("7. Se dau doua variabile numerice a si b ale carori valori sunt date de intrare. Se cere sa se inverseze valorile lor. "); Console.WriteLine();
            Console.WriteLine("8. Se dau doua variabile numerice a si b ale carori valori sunt date de intrare. Se cere sa se inverseze valorile lor fara a folosi alte variabile suplimentare."); Console.WriteLine();
            ...
            Console.WriteLine("16. Se dau 5 numere.Sa se afiseze in ordine crescatoare."); Console.WriteLine();
            ...
            Console.WriteLine("18. Afisati descompunerea in factori primi ai unui numar n.De ex.pentru n = 1776 afisati 2 ^ 3 x 3 ^ 1 x 7 ^ 2."); Console.WriteLine();
